...
public final class Pspot
{
   ...
   static final String DATABASE_NAME = "PotholeSpot.db";
   ...
   public static final class Labels extends LabelsColumns implements android.provider.BaseColumns
   {
      ...
      /** The content:// style URL for this provider, content://nl.sogeti.android.gpstracker/tracks */
      public static final Uri CONTENT_URI = Uri.parse("content://" + Pspot.AUTHORITY + "/" + Labels.TABLE);

      /** The name of this table */
      public static final String TABLE = "labels";
      static final String CREATE_STATEMENT = "CREATE TABLE " + Labels.TABLE + "(" + " " + Labels._ID + " " + Labels._ID_TYPE + "," + " " + Labels.NAME + " " + Labels.NAME_TYPE + "," + " "
            + Labels.CREATION_TIME + " " + Labels.CREATION_TIME_TYPE + "," + " " + Labels.LONGITUDE + " " + Labels.LONGITUDE_TYPE + "," + " " + Labels.LATITUDE + " " + Labels.LATITUDE_TYPE + ","
            + " " + Labels.SPEED + " " + Labels.SPEED_TYPE + "," + " " + Labels.X + " " + Labels.X_TYPE + "," + " " + Labels.Y + " " + Labels.Y_TYPE + "," + " " + Labels.Z + " " + Labels.Z_TYPE
            + ");";
   }
   ...
   public static final class Xyz extends XYZColumns implements android.provider.BaseColumns
   {
      ...
      public static final Uri CONTENT_URI = Uri.parse("content://" + Pspot.AUTHORITY + "/" + Xyz.TABLE);
      ...
      static final String CREATE_STATEMENT = "CREATE TABLE " + Xyz.TABLE + "(" + " " + Xyz._ID + " " + Xyz._ID_TYPE + "," + " " + Xyz.TIME + " " + Xyz.TIME_TYPE + "," + " " + Xyz.SPEED + " "
            + Xyz.SPEED_TYPE + "," + " " + Xyz.X + " " + Xyz.X_TYPE + "," + " " + Xyz.Y + " " + Xyz.Y_TYPE + "," + " " + Xyz.Z + " " + Xyz.Z_TYPE + ");";
      ...
      public static Uri buildUri(final long labelId, final long waypointId, final long xyzId)

      {
         final Builder builder = Labels.CONTENT_URI.buildUpon();
   ...
   public static final class Tracks extends TracksColumns implements android.provider.BaseColumns
   {
      ...
      public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.nl.sogeti.android.track";
      /** The content:// style URL for this provider, content://nl.sogeti.android.gpstracker/tracks */
      public static final Uri CONTENT_URI = Uri.parse("content://" + Pspot.AUTHORITY + "/" + Tracks.TABLE);

      /** The name of this table */
      public static final String TABLE = "tracks";
      static final String CREATE_STATEMENT = "CREATE TABLE " + Tracks.TABLE + "(" + " " + Tracks._ID + " " + Tracks._ID_TYPE + "," + " " + Tracks.NAME + " " + Tracks.NAME_TYPE + "," + " "
   ...
   public static final class Segments extends SegmentsColumns implements android.provider.BaseColumns
   {
      ...
      static final String CREATE_STATMENT = "CREATE TABLE " + Segments.TABLE + "(" + " " + Segments._ID + " " + Segments._ID_TYPE + "," + " " + Segments.TRACK + " " + Segments.TRACK_TYPE + ");";
   }
   ...
   public static final class Waypoints extends WaypointsColumns implements android.provider.BaseColumns
   {
      ...
      static final String CREATE_STATEMENT = "CREATE TABLE " + Waypoints.TABLE + "(" + " " + BaseColumns._ID + " " + WaypointsColumns._ID_TYPE + "," + " " + WaypointsColumns.LATITUDE + " "
            ...
            + "," + " " + WaypointsColumns.SPEED + " " + WaypointsColumns.SPEED + "," + " " + WaypointsColumns.SEGMENT + " " + WaypointsColumns.SEGMENT_TYPE + "," + " " + WaypointsColumns.ACCURACY
            + " " + WaypointsColumns.ACCURACY_TYPE + "," + " " + WaypointsColumns.ALTITUDE + " " + WaypointsColumns.ALTITUDE_TYPE + "," + " " + WaypointsColumns.BEARING + " "
            + WaypointsColumns.BEARING_TYPE + ");";

      static final String[] UPGRADE_STATEMENT_7_TO_8 = { "ALTER TABLE " + Waypoints.TABLE + " ADD COLUMN " + WaypointsColumns.ACCURACY + " " + WaypointsColumns.ACCURACY_TYPE + ";",
       ...
       * @return
       */
      public static Uri buildUri(final long trackId, final long segmentId, final long waypointId)
      {
         final Builder builder = Tracks.CONTENT_URI.buildUpon();
   ...
   public static final class Locations extends LocationsColumns implements android.provider.BaseColumns
   {
      ...
      static final String CREATE_STATEMENT = "CREATE TABLE " + Locations.TABLE + "(" + " " + BaseColumns._ID + " " + LocationsColumns._ID_TYPE + "," + " " + LocationsColumns.LATITUDE + " "
            + LocationsColumns.LATITUDE_TYPE + "," + " " + LocationsColumns.LONGITUDE + " " + LocationsColumns.LONGITUDE_TYPE + "," + " " + LocationsColumns.TIME + " " + LocationsColumns.TIME_TYPE
            + "," + " " + LocationsColumns.SPEED + " " + LocationsColumns.SPEED + "," + " " + LocationsColumns.SEGMENT + " " + LocationsColumns.SEGMENT_TYPE + "," + " " + LocationsColumns.ACCURACY
            + " " + LocationsColumns.ACCURACY_TYPE + "," + " " + LocationsColumns.ALTITUDE + " " + LocationsColumns.ALTITUDE_TYPE + "," + " " + LocationsColumns.BEARING + " "
            + LocationsColumns.BEARING_TYPE + ");";

      static final String[] UPGRADE_STATEMENT_7_TO_8 = { "ALTER TABLE " + Locations.TABLE + " ADD COLUMN " + LocationsColumns.ACCURACY + " " + LocationsColumns.ACCURACY_TYPE + ";",
      ...
      public static Uri buildUri(final long labelId, final long xyzId, final long locationId)
      {
         final Builder builder = Labels.CONTENT_URI.buildUpon();
         ContentUris.appendId(builder, labelId);
         builder.appendPath(Xyz.TABLE);
   ...
   public static final class Media extends MediaColumns implements android.provider.BaseColumns
   {
      ...
      static final String CREATE_STATEMENT = "CREATE TABLE " + Media.TABLE + "(" + " " + BaseColumns._ID + " " + MediaColumns._ID_TYPE + "," + " " + MediaColumns.TRACK + " " + MediaColumns.TRACK_TYPE
            + "," + " " + MediaColumns.SEGMENT + " " + MediaColumns.SEGMENT_TYPE + "," + " " + MediaColumns.WAYPOINT + " " + MediaColumns.WAYPOINT_TYPE + "," + " " + MediaColumns.URI + " "
            + MediaColumns.URI_TYPE + ");";
      public static final Uri CONTENT_URI = Uri.parse("content://" + Pspot.AUTHORITY + "/" + Media.TABLE);
   }
   ...
   public static final class MetaData extends MetaDataColumns implements android.provider.BaseColumns
   {
      ...
      static final String CREATE_STATEMENT = "CREATE TABLE " + MetaData.TABLE + "(" + " " + BaseColumns._ID + " " + MetaDataColumns._ID_TYPE + "," + " " + MetaDataColumns.TRACK + " "
            + MetaDataColumns.TRACK_TYPE + "," + " " + MetaDataColumns.SEGMENT + " " + MetaDataColumns.SEGMENT_TYPE + "," + " " + MetaDataColumns.WAYPOINT + " " + MetaDataColumns.WAYPOINT_TYPE + ","
            + " " + MetaDataColumns.KEY + " " + MetaDataColumns.KEY_TYPE + "," + " " + MetaDataColumns.VALUE + " " + MetaDataColumns.VALUE_TYPE + ");";
      /**
       * content://nl.sogeti.android.gpstracker/metadata
       */
      public static final Uri CONTENT_URI = Uri.parse("content://" + Pspot.AUTHORITY + "/" + MetaData.TABLE);
   }
