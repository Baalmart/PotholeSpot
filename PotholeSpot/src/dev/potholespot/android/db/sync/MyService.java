...
public class MyService extends Service
{
   ...
   public void onStart(final Intent intent, final int startId)
   {
      ...
      mNotifyBuilder = new NotificationCompat.Builder(this).setContentTitle("Alert").setContentText("You've received new messages.").setSmallIcon(R.drawable.ic_launcher);
      // Set pending intent
