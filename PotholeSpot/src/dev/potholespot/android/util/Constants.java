...
public class Constants
{
   ...
   public static final String SERVICENAME = "dev.potholespot.android.intent.action.GPSLoggerService";
   public static final String STREAMBROADCAST = "dev.potholespot.android.intent.action.STREAMBROADCAST";
   ...
   public static final String DEFAULT_EXTERNAL_DIR = "/PotholeSpot/";
   ...
   public static final String LOGGING_STATE_CHANGED_ACTION = "dev.potholespot.android.LOGGING_STATE_CHANGED";
    ...
    * @see #LOGGING_CUSTOM
    */
   public static final String EXTRA_LOGGING_PRECISION = "dev.potholespot.android.EXTRA_LOGGING_PRECISION";
    ...
    * @see #STOPPED
    */
   public static final String EXTRA_LOGGING_STATE = "dev.potholespot.android.EXTRA_LOGGING_STATE";
   ...
   /**
    * Based on preference return the SD-Card directory in which PotholeSpot creates and stores files shared tracks,
    * 
    * @param ctx
    * @return
    */
   ...
   public static String getSdCardDirectory(final Context ctx)
   {
      ...
      final File dirHandle = new File(dir);
   ...
   public static String getSdCardTmpFile(final Context ctx)
   {
      final String dir = getSdCardDirectory(ctx) + TMPICTUREFILE_SUBPATH;
      return dir;
   }
    ...
    */
   public static final String EXTRA_DISTANCE = "dev.potholespot.android.EXTRA_DISTANCE";
   /**
    * A time period in minutes
    */
   public static final String EXTRA_TIME = "dev.potholespot.android.EXTRA_TIME";
   /**
    * The location that pushed beyond the set minimum time or distance
    */
   public static final String EXTRA_LOCATION = "dev.potholespot.android.EXTRA_LOCATION";
   /**
    * The track that is being logged
    */
   public static final String EXTRA_TRACK = "dev.potholespot.android.EXTRA_TRACK";
