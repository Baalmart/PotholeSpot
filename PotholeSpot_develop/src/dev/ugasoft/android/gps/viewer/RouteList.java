...
import dev.ugasoft.android.gps.adapter.SectionedListAdapter;
            ...
            mImportAction = new Runnable()
               {
                  ...
                  public void run()
                  {
                     mService.startDownloadTask(RouteList.this, RouteList.this, track);
                  }
               };
   ...
   protected Dialog onCreateDialog(int id)
   {
      ...
      switch (id)
      {
         ...
         case DIALOG_VACUUM:
            ...
            return dialog;
         case DIALOG_IMPORT:
            builder = new AlertDialog.Builder(RouteList.this).setTitle(R.string.dialog_import_title).setMessage(getString(R.string.dialog_import_message, mImportTrackName))
      ...
      if (resultCode != RESULT_CANCELED)
      {
         switch (requestCode)
         {
            ...
            case DESCRIBE:
               ...
               mService.startUploadTask(RouteList.this, mExportListener, trackUri, name);
               break;
            default:
   ...
   private OnClickListener mVacuumOnClickListener = new DialogInterface.OnClickListener()
      {
         ...
         public void onClick(DialogInterface dialog, int which)
         {
            DatabaseHelper helper = new DatabaseHelper(RouteList.this);
            helper.vacuum();
         }
      };
