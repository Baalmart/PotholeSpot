...
public class LoggerMapHelper
{
   ...
   public void onCreateOptionsMenu(Menu menu)
   {
     ...
     /* menu.add(ContextMenu.NONE, MENU_LAYERS, ContextMenu.NONE, R.string.menu_showLayers).
      ...
      menu.add(ContextMenu.NONE, MENU_NOTE, ContextMenu.NONE, R.string.menu_insertnote).
      setIcon(R.drawable.ic_menu_myplaces);

      menu.add(ContextMenu.NONE, MENU_STATS, ContextMenu.NONE, R.string.menu_statistics).
      setIcon(R.drawable.ic_menu_picture).setAlphabeticShortcut('S');*/
