 ...
 * Original file: /home/baalmart/workspace_potholespot/PotholeSpot_develop/src/dev/ugasoft/android/gps/logger/IGPSLoggerServiceRemote.aidl
 */
package dev.ugasoft.android.gps.logger;
public interface IGPSLoggerServiceRemote extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements dev.ugasoft.android.gps.logger.IGPSLoggerServiceRemote
{
private static final java.lang.String DESCRIPTOR = "dev.ugasoft.android.gps.logger.IGPSLoggerServiceRemote";
...
/**
 * Cast an IBinder object into an dev.ugasoft.android.gps.logger.IGPSLoggerServiceRemote interface,
 * generating a proxy if needed.
 */
public static dev.ugasoft.android.gps.logger.IGPSLoggerServiceRemote asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof dev.ugasoft.android.gps.logger.IGPSLoggerServiceRemote))) {
return ((dev.ugasoft.android.gps.logger.IGPSLoggerServiceRemote)iin);
}
return new dev.ugasoft.android.gps.logger.IGPSLoggerServiceRemote.Stub.Proxy(obj);
}
...
private static class Proxy implements dev.ugasoft.android.gps.logger.IGPSLoggerServiceRemote
{
...
@Override public long startLogging() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
long _result;
...
@Override public android.net.Uri storeMediaUri(android.net.Uri mediaUri) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
@Override public boolean isMediaPrepared() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
@Override public void storeDerivedDataSource(java.lang.String sourceName) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public android.location.Location getLastWaypoint() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
@Override public float getTrackedDistance() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
float _result;
